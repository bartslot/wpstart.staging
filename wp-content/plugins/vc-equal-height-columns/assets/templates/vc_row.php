...
$output = $el_class = $bg_image = $bg_color = $bg_image_repeat = $font_color = $padding = $margin_bottom = $css = $full_width = $equal_height_columns = '';
...
<?php echo $style; ?>
<?php if ($equal_height_columns) : ?>
		 data-equal-height-columns='<?php echo $equal_height_columns; ?>'
<?php endif ?> 		 
>
