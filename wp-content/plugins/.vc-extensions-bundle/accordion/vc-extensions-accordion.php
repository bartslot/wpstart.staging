    ...
    class VC_Extensions_Accordion {
          ...
          wpb_map( array(
            ...
            "params" => array(
              array(
                "type" => "textarea_html",
                "holder" => "div",
                "heading" => __("Accordion content, divide(wrap) each one with &lt;div class=&#039;accordion-content&#039;&gt;&lt;/div&gt;, please edit in text mode:", "vc_accordion_cq"),
                "param_name" => "content",
                "value" => __("<div class='accordion-content'><p>You have to wrap each accordion block in a div with class <strong>accordion-content</strong>.</p> <p>Something like:</p>
                  &lt;div class='accordion-content'&gt;content here...&lt;/div&gt;
                  <p>So you can put anything in it, like a image or video.</p></div>
                  <div class='accordion-content'><p>Hello accordion 2</p>
                  <p>You can customize the title, color, font-size, accordion content etc in the backend.</p>
                  ...
                  <div class='accordion-content'><p>Hello accordion 3</p>
                  ...
                  <p>Yet another accordion.</p>
                  <p>Hi amco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
                  <a href='http://codecanyon.net/user/sike?ref=sike'>Visit my profile</a> for more works.
                  </div>", "vc_accordion_cq"), "description" => __("Enter content for each block here. Divide each with paragraph (Enter).", "vc_accordion_cq") ),
              array(
                "type" => "dropdown",
                "holder" => "",
        ...
        function cq_vc_accordion_func($atts, $content=null) {
          ...
          if($accordionstyle=="style1"){
              $container_start = '<div class="cq-accordion '.$extra_class.'" style="width:'.$contaienrwidth.';">';
              if($title!=""){
              ...
              $container_start .= '<div class="cq-accordion2 '.$extra_class.'" style="width:'.$contaienrwidth.';" data-titlecolor="'.$titlecolor.'" data-titlebg="'.$titlebg.'" data-titlehoverbg="'.$titlehoverbg.'" data-titlehovercolor="'.$titlehovercolor.'">';
              $container_start .= '<dl>';
              $container_end .= '</dl>';
              if($extraborder=="yes"){
