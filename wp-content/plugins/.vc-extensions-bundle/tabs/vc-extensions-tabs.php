          ...
          wpb_map( array(
            ...
            "params" => array(
              array(
                "type" => "textarea_html",
                "holder" => "div",
                "heading" => __("Tabs content, divide(wrap) each one with &lt;div class=&#039;tabs-content&#039;&gt;&lt;/div&gt;, please edit in text mode:", "vc_tabs_cq"),
                "param_name" => "content",
                "value" => __("<p><div class='tabs-content'><p>You have to wrap each tabs block in a div with class <strong>tabs-content</strong>.</p> <p>Something like:</p>
                  &lt;div class='tabs-content'&gt;content here...&lt;/div&gt;
                  <p>So you can put anything in it, like a image or video.</p></div></p>
                  <p><div class='tabs-content'>
                    <p>Tab content 2, please edit it in the text editor.</p>
                  </div></p>
                  <div class='tabs-content'>
                    <p>Tab content 3, please edit it in the text editor.</p>
                    <p><a href='http://codecanyon.net/user/sike?ref=sike'>Visit my profile</a> for more works.</p>
                  </div>
                  <div class='tabs-content'>
                    <p>Yet another content, please edit it in the text editor.</p>
                  </div>", "vc_tabs_cq"), "description" => __("Enter content for each block here. Divide each with paragraph (Enter).", "vc_tabs_cq") ),
              array(
                "type" => "colorpicker",
                "holder" => "div",
                "class" => "",
