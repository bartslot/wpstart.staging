...
if (!class_exists('VC_Extensions_CQCarousel')) {
    ...
    class VC_Extensions_CQCarousel {
        ...
        function cq_vc_cqcarousel_func($atts, $content=null) {
          ...
          // if($onclick=='lightbox'){
          wp_register_script('fs.boxer', plugins_url('../dagallery/js/jquery.fs.boxer.min.js', __FILE__), array('jquery'));
          wp_enqueue_script('fs.boxer');
          wp_register_style('fs.boxer', plugins_url('../dagallery/css/jquery.fs.boxer.css', __FILE__));
