...
$params = array_merge( array(
	...
	array(
		...
		'param_name' => 'el_id',
		'description' => sprintf( __( 'Enter element ID for SVG (Note: make sure it is unique and valid according to <a href="%s" target="_blank">w3c specification</a>).', 'js_composer' ), 'http://www.w3schools.com/tags/att_global_id.asp' ),
	),
	array(
		'type' => 'textfield',
...
return array(
	'name' => __( 'Hover Box SVG', 'js_composer' ),
	'base' => 'vc_cta',
	'icon' => 'vc_icon-vc-hoverboxSVG',
	'category' => array( __( 'Content', 'js_composer' ) ),
	'description' => __( 'Animated flip box with animated SVG and text', 'js_composer' ),
	'params' => $params,
);
